...
#include "TM1637.h"
#define CLK 5 // pin D1 na Wemos D1 Mini
#define DIO 2 // pin D4 na Wemos D1 Mini
...
const char *ssid = "simBox";
const char *password = "simbox123";

// Define a web server at port 80 for HTTP
ESP8266WebServer server(80);

const int ledPin = 4; // an LED is connected to NodeMCU pin D1 (ESP8266 GPIO5) via a 1K Ohm resistor
...
"<html>\
  ...
  <body>\
    <h1>simBox Wi-Fi Control Panel</h1>\
...
<input type=\"button\" id=\"btn\" value=\"Submit\" onClick=\"javascript: window.location.href=('http://42.42.42.42?led=' + document.getElementById('text').value);\" />\
  </body>\
</html>",
